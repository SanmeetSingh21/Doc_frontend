...
const MOCK_MESSAGES = [
  ...
  { id: 'M003', patient: 'Deepa Nair', channel: 'Email', type: 'Medication Reminder', sentAt: '09 Mar 20:00', status: 'delivered' },
...
const CHANNEL_ICON = { WhatsApp: '💬', Email: '📧' }
          ...
          <Card padding="md">
            ...
            <div className={styles.reminderList}>
              {[
                ...
                { patient: 'Lakshmi Iyer', type: 'Delivery Prep', due: '15 Mar', channel: 'Email' },
